...
<path d="M173.377 30.1359L172.662 21.076" stroke="black" stroke-width="3" stroke-linecap="round"/>
          ...
          {/* <button onClick={toggleVisualization} className="toggle-btn">
        ...
        <div className="visualization-container">
          ...
          {steps[currentStepIndex]?.local_vars && (
            ...
            {Object.entries(steps[currentStepIndex].local_vars).map(([key, value]) => (
              <div key={key}>
                <div className="key-box"><span>{key}:</span></div> <div className="value-box"><span className="value">{value}</span></div> 
              </div>
            ))}
          </div>
          )}
